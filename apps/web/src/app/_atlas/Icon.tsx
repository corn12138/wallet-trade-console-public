...
export const ICON_PATHS = {
  ...
  earn: 'M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09Z',
  activity: 'M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z',
  security:
    'm9 12.75 2.25 2.25 4.5-4.5m-13.36-.814a11.959 11.959 0 0 1 3.598-2.7A11.959 11.959 0 0 1 12 2.714c2.291 0 4.545.696 6.5 1.974a11.959 11.959 0 0 1 3.598 2.7c.337.358.337.939 0 1.297a11.959 11.959 0 0 1-3.598 2.7A11.959 11.959 0 0 1 12 13.286c-2.291 0-4.545-.696-6.5-1.974a11.959 11.959 0 0 1-3.598-2.7c-.337-.358-.337-.939 0-1.297Z',
  discover:
  ...
  chevLeft: 'm15.75 19.5-7.5-7.5 7.5-7.5',
  copy: 'M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 0 1 1.5.124m7.5 10.376h3.375c.621 0 1.125-.504 1.125-1.125V11.25c0-4.46-3.243-8.161-7.5-8.876a9.06 9.06 0 0 0-1.5-.124H9.375c-.621 0-1.125.504-1.125 1.125v3.5m7.5 10.375H9.375a1.125 1.125 0 0 1-1.125-1.125v-9.25m12 6.625v-1.875a3.375 3.375 0 0 0-3.375-3.375h-1.5a1.125 1.125 0 0 1-1.125-1.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H9.75',
  ext: 'M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25',
  bolt: 'M3.75 13.5 13.5 3l-1.5 7.5h6.75L9 21l1.5-7.5H3.75Z',
  ...
  star: 'M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.32.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .32-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z',
  globe:
    'M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 0 1 7.843 4.582M12 3a8.997 8.997 0 0 0-7.843 4.582m15.686 0A11.953 11.953 0 0 1 12 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0 1 21 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0 1 12 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 0 1 3 12c0-1.605.42-3.113 1.157-4.418',
  dollar: 'M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4',
  ...
  cube: 'M21 7.5 12 12m0 0L3 7.5M12 12v9m9-12-9-4.5L3 7.5M21 16.5l-9 4.5-9-4.5m0-9L12 3l9 4.5M21 7.5v9L12 21l-9-4.5v-9',
...
export function LogoCube({ size = 36 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" style={{ flex: 'none' }}>
      <polygon points="50,8 92,32 50,56 8,32" fill="#FFD23F" stroke="#000" strokeWidth="5" strokeLinejoin="round" />
      <polygon points="8,32 8,72 50,96 50,56" fill="#FF7043" stroke="#000" strokeWidth="5" strokeLinejoin="round" />
      <polygon points="92,32 92,72 50,96 50,56" fill="#C44CE8" stroke="#000" strokeWidth="5" strokeLinejoin="round" />
    </svg>
  );
}
